export const MODELS = {
  mg3: {
    ...
    defaultImg: '/MG3/Colores/MG3-rojo.png',
    hideCarOnHero: true,
    ...
    colors: [
      { color: '#CC2222', src: '/MG3/Colores/MG3-rojo.png', name: 'Rojo' },
      { color: '#1a1a1a', src: '/MG3/Colores/MG3-negro.png', name: 'Negro' },
      { color: '#fff', src: '/MG3/Colores/MG3-blanco.png', name: 'Blanco', border: '#ddd' },
      { color: '#2266DD', src: '/MG3/Colores/MG3-azul.png', name: 'Azul' },
      { color: '#C0C0C0', src: '/MG3/Colores/MG3-plata.png', name: 'Plata' },
      { color: '#6B6B6B', src: '/MG3/Colores/MG3-gris.png', name: 'Gris' },
      { color: '#F5C518', src: '/MG3/Colores/MG3-amarillo.png', name: 'Amarillo' },
    ],
    specs: [
  ...
  zs: {
    ...
    colors: [
      ...
      { color: '#fff', src: '/ZS/Colores/MG-ZS-HEV-WHITE.webp', name: 'Blanco', border: '#ddd' },
      { color: '#C0C0C0', src: '/ZS/Colores/MG-ZS-HEV-SILVER.webp', name: 'Plata' },
      { color: '#2266DD', src: '/ZS/Colores/MG-ZS-HEV-BLUE.webp', name: 'Azul' },
      { color: '#6B6B6B', src: '/ZS/Colores/MG-ZS-HEV-GRAY.webp', name: 'Gris' },
      { color: '#2E7D32', src: '/ZS/Colores/MG-ZS-HEV-GREEN-MG-4.webp', name: 'Verde' },
    ],
    specs: [
    ...
    exteriorGallery: [
      { src: '/ZS/Exterior/High-left-front-45.webp', alt: 'MG ZS frontal izquierdo alto', wide: true },
      { src: '/ZS/Exterior/The-front.webp', alt: 'MG ZS vista frontal' },
      { src: '/ZS/Exterior/Left-front-80.webp', alt: 'MG ZS frontal izquierdo' },
      { src: '/ZS/Exterior/Left-Rear-45.webp', alt: 'MG ZS trasera izquierda' },
      { src: '/ZS/Exterior/The-Rear.webp', alt: 'MG ZS vista trasera' },
      { src: '/ZS/Exterior/The-side.webp', alt: 'MG ZS vista lateral' },
      { src: '/ZS/Exterior/Low-left-front-15.webp', alt: 'MG ZS frontal bajo' },
      { src: '/ZS/Exterior/Trunk-1-1.webp', alt: 'MG ZS baúl abierto' },
      { src: '/ZS/Exterior/Trunk-1-2.webp', alt: 'MG ZS baúl capacidad' },
      { src: '/ZS/Exterior/Trunk-2-1.webp', alt: 'MG ZS baúl abatido' },
    ],
    interiorGallery: [
      { src: '/ZS/Interior/Side-large-Interior.webp', alt: 'MG ZS interior panorámico' },
      { src: '/ZS/Interior/Steering-Wheel.webp', alt: 'MG ZS volante multifunción' },
      { src: '/ZS/Interior/Instrument-screen.webp', alt: 'MG ZS panel de instrumentos' },
      { src: '/ZS/Interior/UI.webp', alt: 'MG ZS pantalla multimedia' },
      { src: '/ZS/Interior/Copilot-Desk.webp', alt: 'MG ZS panel copiloto' },
      { src: '/ZS/Interior/Electronic-Gear-Level.webp', alt: 'MG ZS palanca electrónica' },
      { src: '/ZS/Interior/First-Row-Seat.webp', alt: 'MG ZS asientos delanteros' },
      { src: '/ZS/Interior/Second-Row-seat.webp', alt: 'MG ZS asientos traseros' },
    ],
    hasFicha: false,
